...
This is the primary adapter since Fara-7B is hosted via LM Studio which
uses the OpenAI SDK.
"""
...
class OpenAIVisualGrounder(VisualGrounder):
    ...
    def __init__(
        ...
        Args:
            ...
            api_base: API base URL (defaults to OPENAI_API_BASE or OpenAI's URL)
            model: Model to use (defaults to NAVIGATOR_LLM_MODEL or gpt-4o)
